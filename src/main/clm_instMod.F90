module clm_instMod
  ...
  use SoilBiogeochemDecompCascadeConType , only : somic_decomp, mimics_decomp, no_soil_decomp, century_decomp, decomp_method
...
contains
  ...
  subroutine clm_instInit(bounds)
    ...
    use SoilBiogeochemDecompCascadeSomicMod  , only : init_decompcascade_somic
